...
struct Tptp {
  ...
  final class SimpleNode : FLEA.Node, StringTyped, ExpressibleByStringLiteral {
  ...
  final class SharingNode : FLEA.SharingNode, StringTyped, ExpressibleByStringLiteral {
  ...
  final class SmartNode : FLEA.SharingNode, StringTyped, ExpressibleByStringLiteral {
  ...
  final class KinNode : FLEA.KinNode, StringTyped, ExpressibleByStringLiteral {
  ...
  final class KinIntNode : FLEA.KinNode, FLEA.StringSymbolTabulating, StringTyped, ExpressibleByStringLiteral {
