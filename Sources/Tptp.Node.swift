...
struct Tptp {
  ...
  final class SharingNode : FLEA.SharingNode, TypedNode, ExpressibleByStringLiteral {
  ...
  final class SmartNode : FLEA.SharingNode, TypedNode, ExpressibleByStringLiteral {
  ...
  final class KinNode : FLEA.KinNode, TypedNode, ExpressibleByStringLiteral {
  ...
  final class KinIntNode : FLEA.KinNode, FLEA.StringSymbolTabulating, TypedNode, ExpressibleByStringLiteral {
